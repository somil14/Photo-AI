...
-- CreateEnum
CREATE TYPE "EthinicityEnum" AS ENUM ('White', 'Black', 'AsianAmerican', 'EastAsian', 'SouthEastAsian', 'SouthAsian', 'Hispanic', 'MiddleEastern', 'Pacific');
...
CREATE TABLE "Model" (
    ...
    "ethnicity" "EthinicityEnum" NOT NULL,
