/*
  ...
  - Added the required column `zeipUrl` to the `Model` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Model" ADD COLUMN     "zeipUrl" TEXT NOT NULL;
